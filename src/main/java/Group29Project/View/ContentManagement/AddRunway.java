...
public class AddRunway {
  ...
  public AddRunway(Airport airport, Runway runway, String position, Controller controller, AddAirport airportUI, boolean dark){
    ...
    // 1 Determine which position is being used
    Label titleLabel;
    if (runway != null){
    ...
    // 21 -- When pressed, pass to error checker
  ...
  // This could be shortened but idc
  // Resets info to empty or selected runway
  ...
  private void resetRunwayInfo(Runway runway){
    ...
    LDAInput2.setText("");
    LDAInput1.setText("");
    thresholdInput1.setText("");
    thresholdInput2.setText("");
    clearwayInput2.setText("");
    clearwayInput1.setText("");
    stopwayInput2.setText("");
    stopwayInput1.setText("");
  ...
  public void attemptToSubmit(Controller controller, Airport airport, Runway runway, String length, String heading, String TORA1, String TODA1, String ASDA1, String LDA1, String threshold1, String clearway1, String stopway1, String TORA2, String TODA2, String ASDA2, String LDA2, String threshold2, String clearway2, String stopway2){
    ...
    if (runway == null){
      ...
      Boolean successfulEdit = controller.editRunway(runway, airport, lengthInt, headingInt, this.position, TORA1Int, TODA1Int, ASDA1Int, LDA1Int, threshold1Int, clearway1Int, stopway1Int, TORA2Int, TODA2Int, ASDA2Int, LDA2Int, threshold2Int, clearway2Int, stopway2Int);
      if (successfulEdit) {
        addRunwayWindow.close();
        parent.manageRunwayButtons();
        CalculationInput.updateAirportDropdown();
